...
py::class_<BiasedProxEnsembleAdaptor>(m, "BiasedProxEnsemble")
    .def(py::init<unsigned int, unsigned int, unsigned int, unsigned long, data_t, data_t, data_t, std::string, std::string, std::string>(), py::arg("max_depth") = 10, py::arg("max_trees") = 0, py::arg("n_classes") = 1, py::arg("seed") = 1234, py::arg("step_size") = 0.01, py::arg("l_reg") = 0.001, py::arg("init_weight") = 0, py::arg("init_mode") = "random", py::arg("next_mode") = "incremental", py::arg("loss") = "cross-entropy")
