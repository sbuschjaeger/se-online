...
py::class_<BiasedProxEnsemble>(m, "BiasedProxEnsemble")
    ...
    .def ("next", &BiasedProxEnsemble::next, py::arg("X"), py::arg("Y"))
    .def ("num_trees", &BiasedProxEnsemble::num_trees)
    .def ("predict_proba", &BiasedProxEnsemble::predict_proba, py::arg("X"));
}